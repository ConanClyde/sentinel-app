...
import { MoreHorizontal, Pencil, Trash2, Mail, Eye, ShieldCheck } from 'lucide-react';
...
export function AdminSection({ users, activeRole, onView, onEdit, onDelete, pagination, roleSlug }: SectionProps) {
    return (
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex justify-between items-start">
                                        <div className="flex flex-col min-w-0">
                                            ...
                                            <div className="flex items-center gap-1.5 text-[10px] text-emerald-600 font-bold uppercase tracking-tighter mt-0.5">
                                    ...
                                    <div className="text-sm text-muted-foreground flex items-center gap-1.5 mt-2 pt-2 border-t">
                                        <Mail className="h-3.5 w-3.5 shrink-0" />
                                        <span className="truncate">{user.email}</span>
                                    </div>
                                    <div className="flex items-center gap-2 mt-3">
                                        <Badge variant="default" className="text-[10px] px-2 py-0">Admin</Badge>
                                        <Badge variant="outline" className="text-[10px] px-2 py-0 border-primary/20 text-primary uppercase font-bold">Full Access</Badge>
                                    </div>
                                </div>
                            </div>
                        </div>
