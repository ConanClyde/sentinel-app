...
export function StaffSection({ users, activeRole, onView, onEdit, onDelete, pagination, roleSlug }: SectionProps) {
    return (
                        ...
                        {users.length === 0 ? (
                            ...
                            users.map((user: any) => (
                                <TableRow key={user.id} className="hover:bg-muted/50 transition-colors">
                                    ...
                                    <TableCell>
                                        <span className="font-mono text-sm">{user.staff_id || 'N/A'}</span>
                                    </TableCell>
                        ...
                        <div key={user.id} className="bg-card active:bg-muted/50 mb-3 rounded-xl border p-4 shadow-sm transition-colors">
                            <div className="flex gap-4">
                                ...
                                <div className="min-w-0 flex-1">
                                    ...
                                    <div className="mt-3">
                                        <div className="text-muted-foreground mb-1 text-[10px] font-bold tracking-wider uppercase">Staff ID</div>
                                        <span className="font-mono text-xs">{user.staff_id || 'N/A'}</span>
                                    </div>
