...
export function DepartmentOfficerSection({ users, activeRole, onView, onEdit, onDelete, pagination, roleSlug }: SectionProps) {
    return (
                                        ...
                                        <DropdownMenu modal={false}>
                                            ...
                                            <DropdownMenuContent align="end" className="w-48">
                                                ...
                                                <DropdownMenuItem onSelect={() => onDelete && onDelete(user.id)} className="text-destructive">
                                                    <Trash2 className="mr-2 h-4 w-4" /> Remove Officer
                                                </DropdownMenuItem>
                                            </DropdownMenuContent>
                                        </DropdownMenu>
                                    </TableCell>
