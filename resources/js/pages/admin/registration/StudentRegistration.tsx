...
export function StudentRegistration({ role: roleProp, colleges, vehicleTypes }: StudentRegistrationProps) {
    ...
    const { data, setData, post, processing } = useForm({
        ...
        program_id: '',
        college_id: '',
        student_id_image: null as File | null,
    ...
    const nextStep = () => {
        ...
        if (currentStep === 2) {
            if (!data.student_id.trim() || !data.program_id || !data.student_id_image) {
                toast.error('Please fill in student ID, program, and student ID photo');
                return;
            }
        }
    ...
    const handleCameraCapture = (file: File) => {
        if (cameraField === 'student_id_image') {
            setData('student_id_image', file);
        } else if (cameraField === 'license_image') {
    ...
    const clearFile = (field: string) => {
        if (field === 'student_id_image') {
            setData('student_id_image', null);
        } else if (field === 'license_image') {
        ...
        <>
            ...
            <div className="flex flex-col gap-2">
                ...
                <CameraPhotoButton
                    ...
                    hasPhoto={!!data.student_id_image}
                    capturedFile={data.student_id_image}
                    onCapture={() => openCamera('student_id_image')}
            ...
            <CameraCaptureDialog
                ...
                title={cameraField === 'student_id_image' ? 'Scan Student ID' : "Scan Driver's License"}
            />
        </>
    );
        ...
        return (
            <div className="space-y-6 text-center">
                <div className="py-8">
                    ...
                    <p className="text-muted-foreground mb-6">The student has been registered successfully.</p>
            ...
            <div className="flex justify-between gap-4">
                ...
                {currentStep < totalSteps ? (
                    ...
                    <Button type="submit" disabled={processing}>
                        ...
                        {processing ? 'Creating...' : 'Register Student'}
                    </Button>
                )}
            </div>
        </form>
