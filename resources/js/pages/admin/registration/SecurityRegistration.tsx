...
export function SecurityRegistration({ role: roleProp, vehicleTypes }: SecurityRegistrationProps) {
    const role = roleProp || 'security';
    ...
    const nextStep = () => {
        ...
        if (currentStep === 2) {
            if (!data.staff_id.trim()) {
                toast.error('Please fill in security ID');
                return;
            }
            if (!data.staff_id_image) {
                toast.error('Please take a photo of your security ID');
                return;
            }
        }
    ...
    const renderStep2 = () => (
        <>
            <h3 className="font-semibold text-lg">Security Details</h3>
            <div className="space-y-2">
                <Label htmlFor="staff_id">Security ID</Label>
                <Input
                    id="staff_id"
                    value={data.staff_id}
            ...
            <div className="flex flex-col gap-2">
                <Label>Security ID Photo</Label>
                <CameraPhotoButton
                    placeholder="Take photo of your Security ID"
            ...
            <CameraCaptureDialog
                ...
                title={cameraField === 'staff_id_image' ? "Scan Security ID" : "Scan Driver's License"}
            />
        </>
    );
        ...
        return (
            <div className="space-y-6 text-center">
                <div className="py-8">
                    ...
                    <p className="text-muted-foreground mb-6">The security personnel has been registered successfully.</p>
                    <Button type="button" onClick={handleRegisterAgain}>
                        <Save className="h-4 w-4 mr-2" />
                        Register Another Security
                    </Button>
                </div>
            </div>
        );
            ...
            <div className="flex justify-between gap-4">
                ...
                {currentStep < totalSteps ? (
                    ...
                    <Button type="submit" disabled={processing}>
                        ...
                        {processing ? 'Creating...' : 'Register Security Personnel'}
                    </Button>
                )}
            </div>
        </form>
