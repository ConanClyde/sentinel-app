...
interface ReporterRegistrationProps {
    role?: string;
    departments?: Department[];
}

export function ReporterRegistration({ departments }: ReporterRegistrationProps) {
    const role = 'reporter';
        ...
        return (
            <div className="space-y-6 text-center">
                <div className="py-8">
                    ...
                    <p className="text-muted-foreground mb-6">The reporter has been registered successfully.</p>
                    <Button type="button" onClick={handleRegisterAgain}>Register Another Reporter</Button>
                </div>
            </div>
        );
    }
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button type="submit" className="w-full" disabled={processing}>
                ...
                {processing ? 'Creating...' : 'Register Reporter'}
            </Button>
        </form>
    );
}
