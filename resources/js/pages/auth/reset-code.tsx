...
export default function ResetCode() {
    ...
    return (
        <AuthLayout title="Reset your password" description="Step 2 of 3: Enter the reset code" backHref={route('password.request')}>
            <Head title="Reset Code" />
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="text-center text-sm">
                        ...
                        <button
                            ...
                            onClick={() => {
                                setResending(true);
                                router.post(route('password.resend-code'), { email: data.email }, {
                                    preserveScroll: true,
