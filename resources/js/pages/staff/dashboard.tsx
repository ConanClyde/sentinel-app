...
import { Car, QrCode, ShieldCheck, User as UserIcon, Briefcase, PlusCircle, ChevronRight, AlertCircle, Map } from 'lucide-react';
            ...
            <div className="flex flex-col gap-4 sm:gap-6">
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    <p className="text-muted-foreground text-sm">
                        Integrated transit and identity management for campus employees. Monitor your vehicle clearance and sticker status below.
                    </p>
                </div>
                ...
                <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                    <Card className="relative overflow-hidden border-none bg-gradient-to-br from-green-500/10 to-green-500/5 dark:from-green-500/20 dark:to-green-500/10 shadow-sm transition-all hover:shadow-md">
                        ...
                        <CardContent>
                            ...
                            <p className="text-xs text-muted-foreground mt-1 font-medium">Active Clearance</p>
                        </CardContent>
                    </Card>
                ...
                <div className="grid gap-4 sm:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-7">
                    ...
                    <Card className="md:col-span-2 lg:col-span-4 border-muted/40 shadow-sm">
                        <CardHeader>
                            ...
                            <CardDescription>Your staff identity and system access level.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="grid sm:grid-cols-2 gap-y-6 gap-x-8">
                                ...
                                <div className="space-y-1">
                                    <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Personnel Email</p>
                                    <p className="text-lg font-bold tracking-tight truncate">{user.email}</p>
                                </div>
                                <div className="space-y-1 sm:col-span-2">
                                    <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">System Role</p>
                            ...
                            <CardContent className="grid grid-cols-1 gap-3">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm font-semibold">New Sticker Request</span>
                                    </div>
                                ...
                                <Button variant="outline" className="h-auto flex items-center justify-between py-4 border-muted/50 hover:bg-background hover:shadow-sm">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm font-semibold">Transit Policies</span>
                                    </div>
                                    <ChevronRight className="h-4 w-4 text-muted-foreground" />
                                </Button>
                            </CardContent>
