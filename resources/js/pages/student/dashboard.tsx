...
import { Car, QrCode, ShieldCheck, User as UserIcon, GraduationCap, PlusCircle, ChevronRight, AlertCircle, Map } from 'lucide-react';
            ...
            <div className="flex flex-col gap-4 sm:gap-6">
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    <p className="text-muted-foreground text-sm">
                        Integrated transit and identity management for campus residents. Monitor your vehicle clearance and sticker status below.
                    </p>
                </div>
                ...
                <div className="grid gap-4 sm:gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-7">
                    ...
                    <Card className="md:col-span-2 lg:col-span-4 border-muted/40 shadow-sm">
                        <CardHeader>
                            ...
                            <CardDescription>Your student identity and system access level.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="grid sm:grid-cols-2 gap-y-6 gap-x-8">
                                ...
                                <div className="space-y-1">
                                    <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground">Auth Email</p>
                            ...
                            <CardContent className="grid grid-cols-1 gap-3">
                                ...
                                <Button variant="outline" className="h-auto flex items-center justify-between py-4 border-muted/50 hover:bg-background hover:shadow-sm">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-sm font-semibold">Download ID</span>
                                    </div>
                                    <ChevronRight className="h-4 w-4 text-muted-foreground" />
                                </Button>
                            </CardContent>
